"""
Task: EvaluateCropDensityImpact
...
output_file = os.path.join(output_path, 'EvaluateCropDensityImpact_result.json')
result_summary = {
    'task_name': 'EvaluateCropDensityImpact',
    'description': 'Analyze the impact of crop density on growth stage and overall crop health.',
...
with open(output_file, 'w') as json_file:
    json.dump(result_summary, json_file, indent=4)

print(f'Results saved to {output_file}. Cleaned rows: {cleaned_rows_count}, Missing rows: {missing_rows_count}.')