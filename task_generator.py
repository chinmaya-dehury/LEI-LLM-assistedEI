...
from resource_monitor import get_system_resources, get_process_resources
...
MODEL_NAME = os.environ.get("MODEL_NAME", TASK_LIST_MODEL)
...
resources_start = {**get_system_resources(), **get_process_resources()}
...
try:
    ...
    resources_end = {**get_system_resources(), **get_process_resources()}
    _write_timing_csv(
        STEP1_CSV_PATH,
        script_start_time,
        script_end_time,
...
try:
    ...
    _write_timing_csv(
        ...
        script_start_time,
        script_end_time,
        script_end_perf - script_start_perf,
        llm_start_time,
        llm_end_time,
        llm_duration,
        0,
