...
try:
    ...
    print("[WARNING] The LLM response was not valid JSON. Saving raw output for review.")
...
print("[OK] The list of all tasks with their description are successfully saved in "+os.path.join(OUTPUT_DIR, "tasks_list.json"))
